      ...
      <div className="text-center space-y-6 max-w-md">
        <div className="flex items-center justify-center gap-3">
          <div className="w-14 h-14 rounded-2xl bg-gold flex items-center justify-center shadow-lg">
            <Scissors className="w-7 h-7 text-gold-foreground" />
          </div>
        </div>
        <h1 className="text-4xl font-bold text-white">PAPI HAIR DESIGN</h1>
        <p className="text-white/50 text-lg">Profesionálny rezervačný systém pre salóny krásy</p>
